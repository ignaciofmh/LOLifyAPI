...
class RanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rank" do
    assert_difference("Rank.count") do
      post ranks_url, params: { rank: { joke_id: @rank.joke_id, rank: @rank.rank, user_id: @rank.user_id } }
    end
  ...
  test "should update rank" do
    patch rank_url(@rank), params: { rank: { joke_id: @rank.joke_id, rank: @rank.rank, user_id: @rank.user_id } }
