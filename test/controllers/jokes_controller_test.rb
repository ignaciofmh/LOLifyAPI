...
class JokesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joke" do
    assert_difference("Joke.count") do
      post jokes_url, params: { joke: { category_id: @joke.category_id, content: @joke.content, rank_avg: @joke.rank_avg, user_id: @joke.user_id } }
    end
  ...
  test "should update joke" do
    patch joke_url(@joke), params: { joke: { category_id: @joke.category_id, content: @joke.content, rank_avg: @joke.rank_avg, user_id: @joke.user_id } }
